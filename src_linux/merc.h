...
typedef struct  race_info			RACE_INFO_DATA;
/* define list */
typedef struct  item_list_info			ITEM_LIST_DATA;
...
#define MAX_STRING_LENGTH     9216 /* 4608 */
#define MAX_INPUT_LENGTH      512  /*256*384 */
#define PAGELEN               22
...
#define LAST_LEVEL			(MAX_LEVEL - 20)
#define LEVEL_HERO          (MAX_LEVEL - 19)
#define LEVEL_MAX_HERO		(MAX_LEVEL - 9)
 ...
 */
#define CLEAR		"\33[0m"		/* Resets Colour	*/
#define C_RED		"\33[0;31m"	/* Normal Colours	*/
#define C_GREEN		"\33[0;32m"
#define C_YELLOW	"\33[0;33m"
#define C_BLUE		"\33[0;34m"
#define C_MAGENTA	"\33[0;35m"
#define C_CYAN		"\33[0;36m"
#define C_WHITE		"\33[0;37m"
#define C_D_GREY	"\33[1;30m"  	/* Light Colors		*/
#define C_B_RED		"\33[1;31m"
#define C_B_GREEN	"\33[1;32m"
#define C_B_YELLOW	"\33[1;33m"
#define C_B_BLUE	"\33[1;34m"
#define C_B_MAGENTA	"\33[1;35m"
#define C_B_CYAN	"\33[1;36m"
#define C_B_WHITE	"\33[1;37m"
/* 050301 */
#define CB_RED        	"\33[0;41m"    /* Normal Colours (Background) */
#define CB_GREEN      	"\33[0;42m"
#define CB_YELLOW    	"\33[0;43m"
#define CB_BLUE        	"\33[0;44m"
#define CB_MAGENTA    	"\33[0;45m"
#define CB_CYAN        	"\33[0;46m"
#define CB_WHITE       	"\33[0;47m"
#define CB_D_GREY    	"\33[1;40m"     /* Light Colors (Background) */
#define CB_B_RED       	"\33[1;41m"
#define CB_B_GREEN    	"\33[1;42m"
#define CB_B_YELLOW    	"\33[1;43m"
#define CB_B_BLUE    	"\33[1;44m"
#define CB_B_MAGENTA   	"\33[1;45m"
#define CB_B_CYAN    	"\33[1;46m"
#define CB_B_WHITE    	"\33[1;47m"
#define C_BLINKING		"\33[5m"
#define C_UNDERSCORE	"\33[4m"
#define C_REVERSE		"\33[7m"
#define CLEAR_SCR		"\33[2J"		/* Clear Screen	*/
#define CLEAR_HOME		"\33[1;1H"		/* cursor home  */
...
#define CON_GET_PLAY_MODE			-8		/*070201b*/
...
struct    class_type
{
    ...
    long    	*weapon;            /* First weapon            sh_int weapon not pointer*/
...
#define ACT_HOLYLIGHT		(Z) /* holylight for mobs */
...
#define AFF_CURSE        		(K)
#define AFF_IN_BOAT	        	(L)    /* unused 061801 */
#define AFF_POISON        		(M)
...
#define ITEM_WINDOW				39 /* 1201A */
#define ITEM_VEHICLE			40 /*061801*/

#define VEHICLE_BOAT			(A)/*061801*/
#define VEHICLE_NONBOAT			(B)/*061801*/
#define VEHICLE_TAKES_DAMAGE	(C)/*061801*/
#define VEHICLE_AIR				(D)/*061801*/
#define VEHICLE_LAND			(E)/*061801*/
...
#define WEAPON_MOVEDRAIN    (J)
#define WEAPON_GROWING      (K)
#define WEAPON_GRIPPED      (L)
#define WEAPON_TALKING      (M)
#define WEAPON_COMMON		(aa)
#define WEAPON_UNCOMMON		(bb)
#define WEAPON_RARE			(cc)
#define WEAPON_VERY_RARE	(dd)
#define WEAPON_UNIQUE		(ee)

/* unique object code 0902 */
#define UOC_COMMON		(A)
#define UOC_UNCOMMON	(B)
#define UOC_RARE		(C)
#define UOC_VERY_RARE	(D)
#define UOC_UNIQUE		(E)
...
/*
 * allow above a level is actually above or equal
 * allow below is the same.
 */
#define ROOM_ALLOW_ABOVE		104
#define ROOM_ALLOW_BELOW		105
#define ROOM_LEVEL10			106
#define ROOM_LEVEL20			107
#define ROOM_LEVEL30			108
#define ROOM_LEVEL40			109
#define ROOM_LEVEL50			110
#define ROOM_LEVEL60			111
#define ROOM_LEVEL70			112
#define ROOM_LEVEL80			113
#define ROOM_LEVEL90			114
...
#define OBJ_STAY_LEVEL			110

/*rare item code*/
#define OBJ_COMMON				111 /*80%*/
#define OBJ_UNCOMMON			112 /*60%*/
#define OBJ_RARE				113 /*40%*/
#define OBJ_VERY_RARE			114 /*20%*/
#define OBJ_UNIQUE				115

#define OBJ_SOCKET1				120
#define OBJ_SOCKET2				121
#define OBJ_SOCKET3				122
...
#define COMM_SHOW_EXP      		(dd)
#define COMM_SHOW_WORTH    		(ee)
...
/*
 * race data in linked list by TAKA
 * (c) 2000 TAKA Ghost Dancer MUD Project team
 */
struct race_info
{
	RACE_INFO_DATA * RInext;
	RACE_INFO_DATA * RIprev;
    ...
    sh_int		race_number;
    int			number_trains;   /* number of trains alotted at creation */
	long		recall_vnum;	/* recall room for race */
	long		morge_vnum;		/* morge vnum */
};

/*
 * Set up linked list begin and end pointers
 */
RACE_INFO_DATA *RIhead, *RItail, *RIptr, *RIhuman;


/* end race linked list stuff TAKA */

/*
 * used to store list of objects
 * by Taka
 */
struct    item_list_info
{
    ITEM_LIST_DATA *    ILnext;
    ITEM_LIST_DATA *    ILprev;
    int			count;
    int			level;
    int			type;
    char *		name;
...
ITEM_LIST_DATA *ILHead, *ILTail, *ILptr;
...
struct    pc_data
{
	...
	*/
    ...
    int         security;    /* OLC */ /* Builder security */
     ...
     int			slay_cnt;
	 /* added by Taka for Paint ball definition */
	 bool			char_in_pb_war;   /* is the player in a paintball war */
	 int			combatant_number; /* what is their combatant number */
	 int			number_shoots;	  /* number of shoots used */
	 /* AFK message a vincent idea */
	 char *			AFK_message; /* not saved but allows for one word description in afk message */
	 /* restore message sent to players */
	 char *         rstmsg;		/* 1129A Taka Restore Message */
	 char *         whotitl;	/* 1214  Taka Who Title */
	/* personal data fields by TAKA 0314 */
	 char *			personal_name;
	 char *			personal_nickname;
	 char *			personal_email;
	 char *			personal_webaddress;
	 char *			personal_icqno;
	 char *			personal_note;
	 /* Personal bonus on exp */
	 int			exp_timer;
	 int			exp_bonus;
	 int			hunger_ticks;
	 bool			rebirth; /* 041801 */
	 int			deity;
	 char *			stor_pw; /* 070201 */
	 int			play_mode; /*070201b*/
	 int			quest_flags[MAX_QUEST]; /*033102*/
	 int			bank_wait;/*060402 by Taka*/
	long	shows; /* added by taka for show command */
	long	show2; /* added by taka for show command */
	long	immpt;
	long	imppt;
	long	questpoints;
...
/* added by Taka for Paint ball definition */
extern bool PB_WAR_INPROGRESS;
extern int  PB_TICKS_TO_JOIN;
extern int  PB_WAR_TIMER;
extern int  NO_COMBATANTS;
extern int  WAR_FIRST_PLAYER;

/* end of paintball war definitions */
...
#define IS_GOD(ch)        (get_trust(ch) >= MAX_LEVEL - 3)
...
extern    char *    const            title_table    [1][1][2];
...
#define WEB_FOLDER	"/home/wedgee/public_html/"
#endif
...
#define RNOTE_FILE      "rnotes.not" /* For 'roleplay notes'1116 */
...
#define TOTALS_FILE		"../data/totals.txt" /* Total counters by Taka 022702 */
...
void show_list_to_char args((OBJ_DATA *list, CHAR_DATA *ch, bool fShort,
                             bool fShowNothing, int Recursive, bool Allow_Recursive,
                             bool ObjList));
...
extern void raw_kill_slay args ((CHAR_DATA * victim));
...
long    weapon_type    args( ( const char *name) );
...
OD *    get_obj_carry    args( ( CHAR_DATA *ch, char *argument,
                CHAR_DATA *viewer ) );
OD *    get_obj_carry2    args( ( CHAR_DATA *ch, char *argument,
                CHAR_DATA *viewer ) );OD *get_obj_wear	args( ( CHAR_DATA *ch, char *argument, bool character ));
...
bool    IS_OUTDOORS      args(( CHAR_DATA *ch ));/* 050201 */
void strip_mortal_color(char *bufin, bool GLOBAL);

/* external in new_dbx.c 022702 */
extern void 	load_total_info	(void);
extern void		save_total_info (void);

/* web.c */
extern void races_html_update (void);
extern void areas_html_update(void);
extern void who_html_update(void);


/* clan.c */
extern void do_copen(CHAR_DATA *ch, char *argument);
extern void do_cclose(CHAR_DATA *ch, char *argument);
extern void update_clan();
extern void save_petition();
...
#define MAX_CLAN_LEADER		4
#define ALLOW_CLAN			1*/




extern	  struct    show_type    show_table	  [64];

struct	  show_type
{
	char *	keyword;	/* keyword used */
	char *	on_text;	/* text when on */
	char *	off_text;	/* text when off */
	long 	*set;		/* set flags in structure */
	long	value;		/* value to set */
	int		level;		/* level to see/set this */
	int		cmd_grp;	/* command group */
};

extern	  struct    cmd_grp    table_grp	  [32];

struct	  cmd_grp
{
	char *	keyword;		/* keyword group name */
	char *	text;			/* text command group description */
	char *	commands[10];	/* commands to put in group */
	long	group;			/* command group */
	long 	*set;			/* set flags in structure */
	long	value;			/* value to set */
};
