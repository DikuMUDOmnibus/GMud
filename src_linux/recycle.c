...
void free_pcdata(PC_DATA *pcdata)
{
    ...
    free_string(pcdata->personal_name);
    free_string(pcdata->personal_nickname);
    free_string(pcdata->personal_email);
    free_string(pcdata->personal_webaddress);
    free_string(pcdata->personal_icqno);
    free_string(pcdata->personal_note);
    free_string(pcdata->spouse);
    free_string(pcdata->history);
    free_string(pcdata->AFK_message);
    free_string(pcdata->rstmsg);
    free_string(pcdata->whotitl);
    free_buf(pcdata->buffer);
/*    free_string(pcdata->history); * TAKAMEMLEAKFIX */
